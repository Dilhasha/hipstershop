...
COPY --from=orderservice-build /home/work-dir/OrderService/target/bin/OrderService.jar /home/work-dir/
...
CMD [ "java", "-jar", "OrderService.jar", "observabilityIncluded=true"]
